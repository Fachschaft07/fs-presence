...
echo ===============================
keytool -importcert -v -trustcacerts -file "server.cer" -alias fspresenceserver -keystore "keystore.bks" -provider org.bouncycastle.jce.provider.BouncyCastleProvider -providerpath "..\misc\bcprov-jdk15on-146.jar" -storetype BKS -storepass "123456"
...
copy keystore.bks ..\FSPresence\FSPresence\res\raw\keystore.bks
